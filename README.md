...
支持RTMP、HLS、SRT、GB28181、webrtc、http-flv：
HLS支持播放广告
关键帧缓存；
秒开画面；
...
webrtc://106.52.79.133/live/livestream
SRT：
srt://106.52.79.133:10080?streamid=#!::h=live/livestream,m=publish
rtmp://106.52.79.133/live/livestream
                                                                设计概念
一、三大抽象概念
发布者（Publisher）
订阅者（Subscriber）
...
用 hdl 拉流即： http://127.0.0.1/live/live/stream1.flv
用hls拉流即： http://127.0.0.1/live/live/stream1.m3u8
用webrtc拉流：webrtc://106.52.79.133/live/livestream
用RTMP拉流：rtmp://106.52.79.133/live/livestream
如果用 OBS 推流，地址填写 rtmp://127.0.0.1/live ，流密钥 stream1 ，最终也是一样。
在 rtmp 协议中， live 称为 app名称， stream1 称为流名称
