(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app"], {
    ...
    "4ec3": function(t, e, n) {
        ...
        var u = "/api"
         // , p = "".replace("http://", "ws://").replace("https://", "wws://") + "/jessica/"
          , p = "".replace("http://", "ws://").replace("https://", "wws://") 
          , f = ""
          , h = "http:" === location.protocol ? "ws:" : "wss:"
          , m = {
            hlsHref: Object(i["h"])() ? f + "/hls/" : "".concat(location.protocol, "//").concat(location.host, "/hls/"),
            hdlHref: Object(i["h"])() ? f + "/hdl/" : "".concat(location.protocol, "//").concat(location.host, "/hdl/"),
            baseHref: Object(i["h"])() ? f : "".concat(location.protocol, "://").concat(location.host),
            //jessibucaHref: Object(i["h"])() ? p : "".concat(h, "//").concat(location.host, "/jessica/"),
            jessibucaHref: Object(i["h"])() ? p : "".concat(h, "//").concat(location.host, "/rtc/v1/play/"),
            fetchPlugins: u + "/gateway/plugins",
            fetchLogList: u + "/logrotate/list",
            fetchLogTail: u + "/logrotate/tail",
            searchLog: u + "/logrotate/find",
            fetchRecordList: u + "/record/flv/list",
            deleteRecordItem: u + "/record/flv/delete",
            stopRecordFlv: u + "/record/flv/stop",
            playRecordFlv: u + "/record/flv/play",
            recordFlv: u + "/record/flv",
            fetchSummary: u + "/summary",
            fetchGb28181: u + "/gb28181/list",
            fetchRtsp: u + "/rtsp/list",
            fetchHls: u + "/hls/list",
            relayRtsp: u + "/rtsp/pull",
            relayHLS: u + "/hls/pull",
            getWebRtcRemoteSdp: u + "/webrtc/play",
            inviteGb28181: u + "/gb28181/invite",
            byeGb28181: u + "/gb28181/bye",
            ptzCmdGb28181: u + "/gb28181/control",
            queryRecords: u + "/gb28181/query/records",
            playRecords: u + "/gb28181/invite",
            stopRecords: u + "/gateway/stop"
        }
          , w = (Object(i["h"])() || "".concat(location.protocol, "://").concat(location.host),
        "".replace("http://", "ws://"),
        m)
          , v = w;
        function g() {
        ...
        function B() {
                ...
                var source = new EventSource(w.fetchSummary);
        ...
        function _(t, e) {
            var urlObject='http://'+location.host+'/rtc/v1/play/';
            var streamurl='webrtc://'+location.host+'/'+t;
            //console.log("111111.apiUrl",w.getWebRtcRemoteSdp,location.host,urlObject,t);
           // getHttppUrl(w.getWebRtcRemoteSdp)
            let objData = {
                sdp: e.sdp,
                type: e.type,
              //  streamurl:"webrtc://10.55.23.36/live/livestream",
              streamurl:streamurl,
            }
    ...
    "56d7": function(t, e, n) {
        ...
        var i = {};
        n.r(i),
        n.d(i, "parseTimeFilter", (function() {
            return ht["j"]
        }
        )),
        ...
        function() {
          ...
          , l = {
            name: "app",
            created: function() {
                this.$store.dispatch("fetchEngineInfo"),
                this.$store.dispatch("fetchPlugins"),
                this.$store.dispatch("fetchSummary"),
                this.$store.dispatch("fetchGb28181")
            },
            destroyed: function() {
          ...
          , d = l
          , u = n("2877")
          , p = Object(u["a"])(d, c, r, !1, null, "538cc079", null)
          , f = p.exports
          , h = (n("b20f"),
        n("8c4f"))
          , m = function() {
          ...
          , w = [function() {
            ...
            }, [t._v("Copyright © 2021-current "), n("strong", [n("a", {
                attrs: {
                    href: "http://aliveyun.com/",
                    target: "_blank"
                }
            }, [t._v("DoC")])]), t._v(" All Rights Reserved.\n    ")])
        }
        ]
          , v = (n("8e6e"),
        n("bd86"))
          ...
          , k = (n("7f7f"),
        {
            ...
            methods: {
                getBreadcrumb: function() {
                    var t = this.$route.matched.filter((function(t) {
                      ...
                      , e = t[0];
                    e && e.meta && e.meta.parent && (t = [e.meta.parent].concat(t)),
                    this.levelList = t
                }
            }
        })
          , C = k
          , z = (n("0650"),
        Object(u["a"])(C, y, M, !1, null, "16b2fb2a", null))
          , O = z.exports
          , q = function() {
            var t = this
              , e = t.$createElement
          ...
          , _ = L
          , S = (n("4c5d"),
        Object(u["a"])(_, q, B, !1, null, "abf990d6", null))
          , j = S.exports
          , D = function() {
            var t = this
              , e = t.$createElement
        ...
        n("93bf"))
          ...
          , A = H
          , I = (n("5ffa"),
        Object(u["a"])(A, D, P, !1, null, "2e0e720e", null))
          , R = I.exports;
        function F(t, e) {
            var n = Object.keys(t);
        ...
        var G = {
          ...
          , V = G
          , $ = (n("c93e"),
        Object(u["a"])(V, b, x, !1, null, "0e0ce7fe", null))
          , N = $.exports
          , U = function() {
            var t = this
              , e = t.$createElement
          ...
          , Q = W
          , X = Object(u["a"])(Q, Y, K, !1, null, null, null)
          , tt = X.exports;
        function et(t, e) {
            var n = Object.keys(t);
            if (Object.getOwnPropertySymbols) {
        ...
        var it = {
          ...
          , st = it
          , ot = (n("5b30"),
        Object(u["a"])(st, U, J, !1, null, "27fe2687", null))
          , at = ot.exports
          , ct = function() {
            var t = this
              , e = t.$createElement
          ...
          , dt = lt
          , ut = (n("22dd"),
        Object(u["a"])(dt, ct, rt, !1, null, "40080ad0", null))
          , pt = ut.exports
          , ft = (n("7514"),
        n("55dd"),
        n("4ec3"))
        ...
        var mt = {
          ...
          , gt = new g["a"].Store({
            ...
            mutations: {
                TOGGLE_SIDEBAR: function(t) {
                    t.sidebar.opened ? mt.sidebarStatus = !0 : mt.sidebarStatus = !1,
            ...
            actions: {
                ...
                fetchPlugins: function(t) {
                    ...
                    return ft["h"]().then((function(t) {
                        ...
                        if (n) {
                            var i = Object(ht["k"])(n.Config)
                              , s = "true" === i.AutoInvite || !0 === i.AutoInvite;
                            e("UPDATE", {
                                gb28181AutoInvite: s
                            })
                        }
                ...
                fetchSummary: function(t) {
                    var e = t.commit;
                    wt || (wt = ft["j"](),
                    wt.onmessage = function(t) {
                        if (t.data) {
                            var n = JSON.parse(t.data);
                            n.Address = location.hostname,
                            n.Streams || (n.Streams = []),
                            n.Streams.sort((function(t, e) {
                                return t.StreamPath > e.StreamPath ? 1 : -1
                            }
                            )),
                            n.updateTimestamp = (new Date).getTime(),
                            e("UPDATE", n)
                        }
                    }
                    )
            ...
            getters: {
                getConfig: function(t) {
                    return function(e) {
                        ...
                        return i && (n = Object(ht["k"])(i.Config)),
                        n
                    }
                }
            }
          ...
          , Ct = {
            watch: {
                $route: function(t) {
                    "mobile" === this.device && this.sidebar.opened && bt.dispatch("closeSideBar", {
                        withoutAnimation: !1
                    })
                }
            },
            ...
            mounted: function() {
                var t = this.isMobile();
                t && (bt.dispatch("toggleDevice", "mobile"),
                bt.dispatch("closeSideBar", {
                    withoutAnimation: !0
                }))
            },
            methods: {
                isMobile: function() {
                    var t = yt.getBoundingClientRect();
                    return t.width - kt < Mt
                },
                resizeHandler: function() {
                    if (!document.hidden) {
                        var t = this.isMobile();
                        bt.dispatch("toggleDevice", t ? "mobile" : "desktop"),
                        t && bt.dispatch("closeSideBar", {
                            withoutAnimation: !0
                        })
                    }
                }
        ...
        var qt = {
          ...
          , Bt = qt
          , Lt = (n("748b"),
        Object(u["a"])(Bt, m, w, !1, null, "38550049", null))
          , _t = Lt.exports
          , St = [{
            path: "/404",
            component: function() {
            ...
            children: [{
                path: "home",
                component: function() {
                    return Promise.all([n.e("chunk-2ab37052"), n.e("chunk-6b0dfb08")]).then(n.bind(null, "7abe"))
                },
                name: "home",
                meta: {
                    title: "监控面板",
            ...
            children: [{
                path: "index",
                component: function() {
                    return Promise.all([n.e("chunk-3f7bc161"), n.e("chunk-0a8ed2d2")]).then(n.bind(null, "e7d7"))
                },
                name: "stream",
                meta: {
                    title: "流列表",
            ...
            children: [{
                path: "index",
                component: function() {
                    return Promise.all([n.e("chunk-6e83591c"), n.e("chunk-0a0d3f30")]).then(n.bind(null, "0e54"))
                },
                name: "gb28181",
                meta: {
                    title: "设备管理",
            ...
            children: [{
                path: "index",
                component: function() {
                    return Promise.all([n.e("chunk-3f7bc161"), n.e("chunk-6e83591c"), n.e("chunk-07dd5348")]).then(n.bind(null, "7fa6"))
                },
                name: "screen",
                meta: {
                    title: "分屏展示",
            ...
            children: [{
                path: "index",
                component: function() {
                    return Promise.all([n.e("chunk-3f7bc161"), n.e("chunk-28a3bb55")]).then(n.bind(null, "caae"))
                },
                name: "record",
                meta: {
                    title: "录像回看",
            ...
            children: [{
                path: "index",
                component: function() {
                    return n.e("chunk-552ca6f6").then(n.bind(null, "be69"))
                },
                name: "logs",
                meta: {
                    title: "操作日志",
        ...
        var Rt = function() {
          ...
          , Gt = Zt
          , Vt = (n("d2ad"),
        Object(u["a"])(Gt, Rt, Ft, !1, null, "8ecbe8e8", null))
          , $t = Vt.exports;
        s["default"].component("svg-icon", $t);
        var Nt = function(t) {
            return t.keys().map(t)
        }
          , Ut = n("51ff");
    ...
    ed08: function(t, e, n) {
        ...
        function s(t, e) {
            if (0 === arguments.length)
                return null;
            var n, s = e || "{y}-{m}-{d} {h}:{i}:{s}";
            "object" === Object(i["a"])(t) || 10 === ("" + t).length && (t = 1e3 * parseInt(t),
            t = +t),
            n = new Date(t);
            var o = {
                y: n.getFullYear(),
              ...
              , a = s.replace(/{(y|m|d|h|i|s|a)+}/g, (function(t, e) {
                var n = o[e];
        ...
        function o(t) {
            ...
            var e = Date.parse(new Date)
              ...
              , a = parseInt(i / 30)
              , c = parseInt(a / 12);
            return c ? c + "年前" : a ? a + "个月前" : i ? i + "天前" : s ? s + "小时前" : o ? o + "分钟前" : "刚刚"
        }
        function a(t) {
            if (t > 1e3) {
                var e = t / 1e3;
        ...
        var l = function() {
            for (var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 100, e = [], n = 0; n < t; n++)
                e.push("");
            return e
        };
        function d(t) {
            ...
            return t > 1024 && n[e] ? d(t / 1024, n[e]) : t.toFixed(2).replace(".00", "") + e + "B"
        }
        function u(t, e) {
            var n = new Date
              , i = new Date;
            t && (n = new Date(t)),
            e && (i = new Date(e));
            var s = i.getTime() - n.getTime()
              , o = 0
              , a = 0
              , c = 0
              , r = 0;
            return s >= 0 && (o = Math.floor(s / 1e3 / 3600 / 24),
            a = Math.floor(s / 1e3 / 60 / 60 % 24),
        ...
        function f(t, e) {
            var n;
            t || e ? "[object Date]" !== Object.prototype.toString.call(t) && null !== t && "object" === Object(i["a"])(t) ? (e = t,
            n = new Date) : "[object Date]" === Object.prototype.toString.call(t) ? n = t : (10 === ("" + t).length && (t = 1e3 * parseInt(t)),
            t = +t,
            n = new Date(t)) : n = new Date,
            e = e || {};
            var s = {
                start: 0,
                end: 0
            }
              , o = new Date(n).setHours(e.startHour || 0, e.startMin || 0, 0, 0)
              , a = new Date(n).setHours(e.endHour || 23, e.endMin || 59, 59, 0);
            return s.start = new Date(o).getTime(),
            s.end = new Date(a).getTime(),
            s
        }
        function h() {
            return !1
